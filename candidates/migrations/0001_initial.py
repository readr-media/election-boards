    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('votes_detail', django.contrib.postgres.fields.jsonb.JSONField(null=True)),
                ...
                ('data', django.contrib.postgres.fields.jsonb.JSONField(null=True)),
                ('candidate', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='each_terms', to='candidates.Candidates', to_field='uid')),
                ('elected_councilor', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='elected_candidate', to='councilors.CouncilorsDetail')),
            ],
            options={
